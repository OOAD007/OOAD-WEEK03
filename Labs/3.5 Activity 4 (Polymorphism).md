...
int คือ ไว้กำหนดค่าแทนจำนวนเต็ม
String เป็นตัวกำหนดค่าตัวอักษร
float จุดทศนิยม
...
รันและสังเกตผลการทำงานของโปรแกรม มีสิ่งใดผิดปกติหรือไม่ อย่างไร
อธิบายการทำงาน ตามที่เข้าใจ
เป็นการกำหนดตัวแปร x,y แกน x แกน y ใน v1 v2 มาคำนวณหาค่า แกน x แกน y ใน v3 
...
รันและสังเกตผลการทำงานของโปรแกรม มีสิ่งใดผิดปกติหรือไม่ อย่างไร
อธิบายการทำงาน ตามที่เข้าใจ มีการเกิดผลซ้ำกัน บางคำสั่ง 
การประกาศแบบใด ที่ทำให้เกิด method overriding และ method hiding.
แบบ overiding จะเป็นแบบ overriding และ hiding จะเป็นแบบ New
