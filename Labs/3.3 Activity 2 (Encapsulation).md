...
เปลี่ยนแค่ตัวเลขจาก3.5 เป็น 7.5 
...
รันและสังเกตผลการทำงานของโปรแกรม มีสิ่งใดผิดปกติหรือไม่ อย่างไร
ผิดปกติ เมื่อเปลี่ยนเป็น private เข้าถึงไม่ได้
...
ทดลองเปลี่ยน GPA เป็นค่าที่มากกว่า 4.0  ผลที่ได้เป็นเช่นไร 
 error 
## สรุปผลการทดลอง
ถ้าต้องการให้ fields ถูกปิดบังจากภายนอก จึงต้องกำหนด access modifier เป็น private ทำให้ไม่สามารถกำนดค่า fields ต่างๆได้ และการใช้งาน properties มีประโยชน์ในเรื่องการตวบคุมการเข้าถึงข้อมูล ผ่านเมธอด 
##  คำถาม
